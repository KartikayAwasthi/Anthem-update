...
// Import INARA images
const inaraImg = "/inara-ecom/White/white-inara4.jpg";
const inaraImg1 = "/inara-ecom/White/Pearl-white-inara4.jpg";
const inaraImg2 = "/inara-ecom/Brown/brown-inara4.jpg";
const inaraImg3 = "/inara-ecom/Black/black-inara4.jpg";
const inaraImg4 = "/inara-ecom/Blue/Blue-Inara4.jpg";
const inaraImg5 = "/inara-ecom/Golden/golden-inara4.jpg";
const inaraImg6 = "/inara-ecom/Purple/purple-inara4.jpg";
const inaraImg7 = "/inara-ecom/White/white-inara4.jpg";
            ...
            >
              ...
              <div className="absolute top-4 left-4 right-4 flex justify-between items-center z-20">
                <div className="bg-black/50 text-white text-sm px-4 py-2 rounded-full backdrop-blur-sm">
                  <span className="font-medium">{fullscreenImageIndex + 1} / {inaraCreatives.length}</span>
                </div>
                <button
                  onClick={closeFullscreen}
              ...
              >
                ...
                >
                  <motion.img
                    ...
                    src={inaraCreatives[fullscreenImageIndex]}
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mb-4">
                <div className="flex items-center gap-1">
                  ...
                  <span className="text-gray-300 ml-2">({inaraData.rating})</span>
                </div>
            ...
            <div className="pt-6 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex justify-between items-center border-b border-[#444] pb-3">
                  ...
                  <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.brandName}</span>
                </div>
                <div className="flex justify-between items-center border-b border-[#444] pb-3">
                  <span className="text-gray-400 text-sm">Model Name</span>
                  <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.modelName}</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex justify-between items-start border-b border-[#444] pb-3">
                    ...
                    <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.manufacturerAddress.company}</span>
                  </div>
                  <div className="flex justify-between items-start border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Address</span>
                    <span className="text-white font-medium text-sm text-right max-w-xs">{inaraData.itemDetails.manufacturerAddress.address}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Phone</span>
                    <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.manufacturerAddress.phone}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Email</span>
                    <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.manufacturerAddress.email}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400 text-sm">Website</span>
                    <span className="text-white font-medium text-sm text-right">{inaraData.itemDetails.manufacturerAddress.website}</span>
                  </div>
                </div>
              </div>
            </div>
