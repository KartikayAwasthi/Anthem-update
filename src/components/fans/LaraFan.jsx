...
const laraData = {
  ...
  itemDetails: {
    ...
    modelName: "LARA",
    bldcComponents: [
      // LARA is induction-only, but included for consistency
      "BLDC Motor Assembly",
    ...
    inductionComponents: [
      "Reliable Induction Motor Assembly",
      "Aerodynamic Fan Blades (3 pieces)",
      "Classic Canopy",
      "Wall Switch Control",
...
const LaraFan = () => {
  ...
  const getCurrentComponents = () => {
    ...
    // Default fallback (LARA is induction-only)
    return laraData.itemDetails.inductionComponents || [];
  };
  ...
  return (
    <div className="bg-[#1c1c1c] text-white min-h-screen pt-24 pb-20">
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <div
            className="flex items-center justify-between cursor-pointer hover:bg-[#3a3a3a] rounded-lg transition-colors duration-300 p-2 -m-2"
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    ...
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.brandName}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Model Name</span>
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.modelName}</span>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-3">
                  <div className="flex justify-between items-start border-b border-[#444] pb-3">
                    ...
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.manufacturerAddress.company}</span>
                  </div>
                  <div className="flex justify-between items-start border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Address</span>
                    <span className="text-white font-medium text-sm text-right max-w-xs">{laraData.itemDetails.manufacturerAddress.address}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Phone</span>
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.manufacturerAddress.phone}</span>
                  </div>
                  <div className="flex justify-between items-center border-b border-[#444] pb-3">
                    <span className="text-gray-400 text-sm">Email</span>
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.manufacturerAddress.email}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400 text-sm">Website</span>
                    <span className="text-white font-medium text-sm text-right">{laraData.itemDetails.manufacturerAddress.website}</span>
                  </div>
                </div>
              </div>
            </div>
