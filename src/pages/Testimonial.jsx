...
export default function Testimonial() {
  ...
  return (
    <section className="py-20 bg-gradient-to-br from-[#1a1a1a] via-[#2f2f2f] to-[#1a1a1a] snap-start w-full px-4 md:px-12 relative overflow-hidden" id="testimonials">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          >
            <button
              ...
              className="group p-3 bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-full border border-[#ba6a5a]/30 hover:border-[#ba6a5a]/50 transition-all duration-300 hover:scale-110"
            >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
                  {getVisibleTestimonials().map((testimonial, index) => (
                    <motion.article
                      ...
                      className="group relative bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-3xl p-6 shadow-2xl border border-[#ba6a5a]/20 hover:border-[#ba6a5a]/50 transition-all duration-700 overflow-hidden"
                      style={{ 
                    ...
                    >
                      ...
                      <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                        <div className="absolute inset-0 rounded-3xl bg-gradient-to-r from-[#ba6a5a] via-[#e49385] to-[#ba6a5a] p-[2px]">
                          <div className="w-full h-full bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-3xl"></div>
                        </div>
                      </div>
                      ...
                      <div className="relative z-10 space-y-2 mb-4">
                        <div className="flex items-center justify-between p-2.5 bg-[#1a1a1a] rounded-xl border border-[#ba6a5a]/10">
        ...
        >
          {[
            ...
            <motion.div
              key={index}
              className="text-center p-6 bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-2xl border border-[#ba6a5a]/20 hover:border-[#ba6a5a]/40 transition-all duration-300"
