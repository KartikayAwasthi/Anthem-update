...
const SectionLoading = ({ height = "h-64" }) => (
  <div className={`${height} bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-3xl animate-pulse flex items-center justify-center`}>
...
const PageLoading = () => (
  <div className="bg-[#1c1c1c] text-white min-h-screen pt-20 pb-16 w-full">
