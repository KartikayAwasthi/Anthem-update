...
const Dealer = () => {
  return (
    <div className="bg-gradient-to-br from-[#1a1a1a] via-[#2f2f2f] to-[#1a1a1a] text-white py-16 w-full relative overflow-hidden" id="dealer">
      {/* Background Pattern */}
      ...
      <div className="relative z-10 px-4 md:px-12 max-w-7xl mx-auto space-y-20">
        ...
        {/* Premium Online Marketplace Section */}
        <section aria-labelledby="online-links" className="relative">
          <div className="text-center mb-12">
            ...
            >
              Available on India's leading e-commerce platforms with secure delivery and authentic warranty
            </motion.p>
          </div>
          ...
          >
            <motion.a
              ...
              className="group relative bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] p-8 rounded-3xl shadow-2xl border border-[#ba6a5a]/10 hover:border-[#ba6a5a]/30 transition-all duration-500 overflow-hidden"
              whileHover={{ 
                scale: 1.05,
                rotateX: 5,
                rotateY: 5
            ...
            >
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 via-transparent to-yellow-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
              
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <img src={amazonLogo} alt="Amazon" className="h-12 w-auto filter brightness-0 invert" />
                </div>
                <h4 className="text-xl font-bold text-white mb-2 group-hover:text-[#e49385] transition-colors duration-300">
                  Amazon India
                </h4>
                <p className="text-gray-400 text-sm mb-4">Fast delivery & easy returns</p>
              ...
              {/* Decorative Elements */}
              <div className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-orange-500 to-yellow-500 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
            </motion.a>
            ...
            >
              {/* Glow Effect */}
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500/10 via-transparent to-yellow-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl"></div>
              
              <div className="relative z-10 flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-white/10 backdrop-blur-md rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                  <img src={flipkartLogo} alt="Flipkart" className="h-12 w-auto filter brightness-0 invert" />
                </div>
                <h4 className="text-xl font-bold text-white mb-2 group-hover:text-[#e49385] transition-colors duration-300">
                  Flipkart
                </h4>
                <p className="text-gray-400 text-sm mb-4">Assured quality & warranty</p>
                <div className="flex items-center gap-2 text-sm text-gray-300">
                  <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
                  Available Now
                </div>
              ...
              {/* Decorative Elements */}
              <div className="absolute top-4 right-4 w-8 h-8 bg-gradient-to-br from-blue-500 to-yellow-500 rounded-full opacity-20 group-hover:opacity-40 transition-opacity duration-300"></div>
            </motion.a>
          </motion.div>
        </section>
        ...
        <section className="relative">
          <motion.div
            className="bg-gradient-to-br from-[#2a2a2a] to-[#1f1f1f] rounded-3xl p-8 border border-[#ba6a5a]/20 text-center relative overflow-hidden"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.6 }}
